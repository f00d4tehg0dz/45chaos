...
<html lang="en">
  <head>
    ...
    <meta name="description" content="A chronicle of the chaos of Donald Trump’s presidency, including lists of all the departures, failed nominations, and empty positions. Including a Mooch Calculator!" />
    <meta name="keywords" content="white house resignations,EPA resignation, EPA firing, State Department empty, White house firing, White house resignation, Advisory Council disbanded, advisory council resignation, Trump nominees, mooch calculator, moochs calculator, total mooch, mooch, 45chaos, ">
    ...
    <meta name="twitter:title" content="The Chaos of Donald Trumps Presidency" />
    <meta name="twitter:site" content="https://45chaos.com" />
    <meta name="twitter:image" content="https://45chaos.com/img/social.png" />
    <meta name="twitter:creator" content="@ImagineWorldas1" />
    <!--- Fav --->
    ...
    <!--- Fonts --->
    <link href="https://fonts.googleapis.com/css?family=ATitillium+Web:200,400,900|Fjalla+One|Open+Sans:100,200,300,400" rel="stylesheet">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="https://45chaos.com">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://45chaos.com/mooches">Mooches</a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <div class="jumbotron jumbotron-fluid image">
        <div class="container">
          ...
          <p> Search for Trump administration departures </p>
             ...
             <form action="" role="search" class="form-inline justify-content-center" method='post'>
          <div class="col-md-5 col-sm-8">   <div class="input-group">
        <input type="text" class="searchs form-control" id="search_box" name="search" placeholder="Type in a Name and Go!">
...
<section class="table-information">
 <div class="container-fluid">
   ...
   <div class="number-tables"></div>
                               <div class="row no-gutters f-table-row-first">
                                 <span class="col-sm-1" id="sort">Sort By</span>
                                   <div class="col-sm-2 f-table-col"><a href="#" class="f-table-sorter fas desc"  data-action="sort-asc">
                                           Name
                                   </a></div>
                                   <div class="col-sm-1 f-table-col"><a href="#" class="f-table-sorter fas"  data-action="sort-asc">
                                           Affliation
                                   </a></div>
                                   <div class="col-sm-2 f-table-col"><a href="#" class="f-table-sorter" data-action="sort-asc">
                                           Position
                                   </a></div>
                                   <div class="col-sm-1 f-table-col"><a href="#" class="f-table-sorter" data-action="sort-desc">
                                           Hired
                                   </a></div>
                                   <div class="col-sm-1 f-table-col"><a href="#" class="f-table-sorter"  data-action="sort-asc">
                                           Left
                                   </a></div>
                                   <div class="col-sm-1 f-table-col"><a href="#" class="f-table-sorter"  data-action="sort-asc">
                                           Total Days
                               ...
                               <?php  require 'dbconnect.php';
                                 ...
                                 $query = $db->query("SELECT * FROM mooches_table  ORDER BY id DESC LIMIT 2000");
                                 $i = 0;
                                 $c = 0;
                                 if ($query->num_rows > 0) {
                           ...
                           <div class="row no-gutters f-table-row cards">
                               ...
                               <div class="col-sm-1 f-table-col">
                                   <div class="firstinfo"><img src="./img/<?php echo $row['img']; ?>.JPG" width="80"/></div>
                                 </div> <!--- Profile Image --->
                                   ...
                                   <div class="clearfix hidden-sm hidden-md hidden-lg"></div>
                                   <div class="profileinfo  col-sm-1 f-table-col">
                                       <h5 data-title="Total Days" ><?php echo $row['TotalTimes']; ?></h5>
                                   </div> <!--- Profile Time --->
                                    <div class="clearfix hidden-sm hidden-md hidden-lg"></div>
                                   <div class="profileinfo  col-sm-1 f-table-col">
                                       <p  class="days-trump"  data-title="Under Trump"><?php echo $row['TimesunderTrump']; ?></p>
                                   </div>  <!--- Profile Trump Time --->
                                    <div class="clearfix hidden-sm hidden-md hidden-lg"></div>
                                   <div class="profileinfo col-sm-1 f-table-col">
                                     <div class="row">
                                        <div class="col-md-12">
 ...
 <div class="clearfix hidden-sm hidden-md hidden-lg"></div>
                              ...
                              view notes</button>
                               <div class="clearfix hidden-sm hidden-md hidden-lg"></div>
                           <div id="commentcard<?php echo $c++; ?>" class="collapses" data-toggle="collapse" >
                              ...
                              <footer class="page-footer font-small blue pt-4 mt-4">
                                ...
                                <!--- Footer --->
                                <button class="btn to-the-top" title="Go to top"><i class="fas fa-angle-up"></i>Top</button>
    <!-- Optional JavaScript -->
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
      <script src="js/jquery.fakeTableSort.js"></script>
...
$('.f-table').fakeTableSortable({
    headerItems: 'div.f-table-row-first > div',
    lineItems: 'div.f-table-row',
    cellItems: 'div.f-table-col',
    firstSort: 'asc',
    sortMethods: ['lexicographical','lexicographical', 'lexicographical', 'lexicographical',  'lexicographical', 'number', 'number','number','number', 'lexicographical']
    //textConverter: [null, null, null, null, null, null, null, null, null, null]
